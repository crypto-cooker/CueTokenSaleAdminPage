<template>
  <div class="bg-gray-100">
    ...
    <section class="bg-gradient-to-r from-blue-500 to-purple-600 py-12 lg:px-10">
      <div v-if="!is_paused&&(networkId==1||networkId==56)" class="m-auto d-flex lg:w-2/6 bg-white p-4 rounded .shadow-2xl">
        ...
        <div class="mt-2 flex flex-row items-center justify-between mb-6 px-6">
          <input class="pl-2 w-6/12 font-medium text-xl py-1 rounded border-2 focus:outline-none focus:shadow-outline" type="text" placeholder="Input Maximum" v-model="maximum">
          <button class="w-5/12 bg-purple-600 hover:bg-purple-700 text-white font-medium py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button"
            @click="setMaximum"
          >
            Set Maximum
        ...
        <div class="mt-2 flex flex-row items-center justify-between mb-6 px-6">
          <input class="pl-2 w-6/12 font-medium text-xl py-1 rounded border-2 focus:outline-none focus:shadow-outline" type="text" placeholder="Input Cap" v-model="cap">
          <button class="w-5/12 bg-purple-600 hover:bg-purple-700 text-white font-medium py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button"
            @click="setCap"
          >
            Set Cap
        ...
        <div class="mt-2 flex flex-row items-center justify-between mb-6 px-6">
          <input class="pl-2 w-6/12 font-medium text-xl py-1 rounded border-2 focus:outline-none focus:shadow-outline" type="text" placeholder="Input End" v-model="end">
          <button class="w-5/12 bg-purple-600 hover:bg-purple-700 text-white font-medium py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button"
            @click="setEnd"
          >
            Set End
